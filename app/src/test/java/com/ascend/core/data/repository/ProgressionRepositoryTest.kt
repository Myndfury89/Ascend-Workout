...
class ProgressionRepositoryTest {
    ...
    @Test
    fun `award xp exactly once and recompute level`() =
        runTest {
    ...
    @Test
    fun `reversing xp recomputes progression downward`() =
        runTest {
    ...
    @Test
    fun `attributes are granted once per source`() =
        runTest {
    ...
    @Test
    fun `multiple level ups are handled in a single award`() =
        runTest {
