...
interface XpDao {
    ...
    suspend fun find(type: String, sourceType: String, sourceId: String): XpTransactionEntity?
...
interface AttributeDao {
    ...
    suspend fun totalForAttribute(userId: String, attributeType: String): Long
